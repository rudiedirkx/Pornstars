...
--
-- Machine: localhost
-- Genereertijd: 22 Aug 2010 om 06:07
-- Serverversie: 5.1.36
-- PHP-Versie: 5.3.0
...
INSERT INTO `planets` (`id`, `email`, `password`, `activationcode`, `oldpwd`, `race_id`, `rulername`, `planetname`, `galaxy_id`, `z`, `crystal`, `metal`, `energy`, `metal_asteroids`, `crystal_asteroids`, `energy_asteroids`, `uninitiated_asteroids`, `lastlogin`, `lastaction`, `alliance_id`, `score`, `sleep`, `nextsleep`, `closed`, `voted_for_planet_id`, `newbie_ticks`, `journal`, `show_all_r_d`, `autoscansave`, `unihash`) VALUES
(1, 'info@jouwmoeder.nl', '1a1347681a2adead044b1e0e2a3ff99a', '', '0', 1, 'Lazy Rudie', 'Sleepy Planet', 1, 2, 1395967, 79792957, 24284, 1354, 813, 0, 0, 1281819753, 1281820007, NULL, 10305133, 0, 1199859127, '0', 2, 0, 'Kenkert', '1', '0', 'MnPXZ0o2uASM1lW2'),
